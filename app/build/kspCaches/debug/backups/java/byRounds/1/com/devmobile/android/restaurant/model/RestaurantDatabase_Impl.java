...
import com.devmobile.android.restaurant.viewmodel.dao.IFoodDao;
import com.devmobile.android.restaurant.viewmodel.dao.IFoodDao_Impl;
import com.devmobile.android.restaurant.viewmodel.dao.IUserDao;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(17) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoUsers.equals(_existingUsers)) {
          return new RoomOpenHelper.ValidationResult(false, "users(com.devmobile.android.restaurant.model.User).\n"
                  + " Expected:\n" + _infoUsers + "\n"
                  + " Found:\n" + _existingUsers);
        }
