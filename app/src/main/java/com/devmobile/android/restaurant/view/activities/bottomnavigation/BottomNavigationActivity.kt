...
class BottomNavigationActivity : AppCompatActivity() {
    ...
    private val homeFragment =
        HomeFragment().apply { arguments = Bundle().apply { putInt("FRAGMENT_INDEX", 0) } }
    private val qrCodeFragment =
        QrCodeFragment().apply { arguments = Bundle().apply { putInt("FRAGMENT_INDEX", 1) } }
    private val mapFragment =
        MapFragment().apply { arguments = Bundle().apply { putInt("FRAGMENT_INDEX", 2) } }
    private val accountFragment =
        AccountFragment().apply { arguments = Bundle().apply { putInt("FRAGMENT_INDEX", 3) } }
